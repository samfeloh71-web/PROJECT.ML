...
• Use plain text only - write like you're having a professional conversation
• Use emojis sparingly for clarity (👥 customers, 💰 revenue, ⚠️ risks, 🎯 opportunities)
...
• Write in clear paragraphs, not formatted lists
...
• Suggest next steps when appropriate"""
        ...
        ai_response = ai_response.replace('###', '')  # Remove headers
        ai_response = ai_response.replace('##', '')   # Remove headers
        ai_response = ai_response.replace('#', '')    # Remove headers
        ai_response = re.sub(r'^\s*[-•]\s*', '', ai_response, flags=re.MULTILINE)  # Clean up bullet points
